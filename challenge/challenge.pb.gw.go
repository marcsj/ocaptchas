...
func request_Challenge_SolveSession_0(ctx context.Context, marshaler runtime.Marshaler, client ChallengeClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SessionSolution
	var metadata runtime.ServerMetadata
	...
	msg, err := client.SolveSession(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Challenge_SolveSession_0(ctx context.Context, marshaler runtime.Marshaler, server ChallengeServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SessionSolution
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SolveSession(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterChallengeHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChallengeServer) error {
	...
	mux.Handle("POST", pattern_Challenge_SolveSession_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Challenge_SolveSession_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Challenge_SolveSession_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterChallengeHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChallengeClient) error {
	...
	mux.Handle("POST", pattern_Challenge_SolveSession_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Challenge_SolveSession_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Challenge_SolveSession_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"solve"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_Challenge_SolveSession_0 = runtime.ForwardResponseMessage
)
